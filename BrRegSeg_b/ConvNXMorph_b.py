...
# The architecture of ConvNeXt-R Block.
...
class ConvNXMorph_b(nn.Module):
    ...
    def __init__(self,
        ...
        self.ConvNeXt_R_Encoder_Decoder = ConvNeXt_R_Encoder_Decoder(
    ...
    def forward(self, x: torch.Tensor):
        ...
        source = x[:, 0:1, :, :]
        x = self.ConvNeXt_R_Encoder_Decoder(x)
...
if __name__ == "__main__":
    ...
    #Model
    print(' Butlding model..')
    img_size = (224,224,144)
    batch_size=1
    model = ConvNXMorph_b(img_size, batch_size)
    dummy_input = torch.randn(1,2,224,224,144)
